...
(function (Vindmijnwijn) {
    var VMWKiyoh = /** @class */ (function () {
        ...
        VMWKiyoh.prototype.xhrReady = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!(this.readyState == 4 && this.status == 200)) return [3 /*break*/, 4];
                            // @ts-ignore
                            window.vmw = {};
                            _b.label = 1;
                        case 1:
        ...
        Object.defineProperty(VMWKiyoh.prototype, "average", {
            ...
            set: function (value) { this._average = value; },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(VMWKiyoh.prototype, "dataUrl", {
            get: function () { return this._data_url; },
            set: function (value) { this._data_url = value; },
            enumerable: true,
            configurable: true
        });
        return VMWKiyoh;
